class WeaponsController < ApplicationController
  ...
  private
    ...
    def weapon_params
      params.require(:weapon).permit(:name, :description, :attack_attribute, :damage, :cost, :range, :ammo_efficiency, :ammo_id, :long_reload, :tech_level, :psitech, :encumberance, :heavy_weapon)
    end
end
